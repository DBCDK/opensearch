...
// Generated: Wed Aug 25 13:12:30 2010
...
const DbcAddiRelations = function() {
    ...
    /**
    * Will also set the inverse relation http://oss.dbc.dk/rdf/dbcaddi#isImageOf
    */
    that.hasImage = function ( pid1, pid2 ){
        Log.info( "Start hasImage" );
        scriptClass.createRelation( pid2, "http://oss.dbc.dk/rdf/dbcaddi#isImageOf", pid1);
        scriptClass.createRelation( pid1, "http://oss.dbc.dk/rdf/dbcaddi#hasImage", pid2 );
