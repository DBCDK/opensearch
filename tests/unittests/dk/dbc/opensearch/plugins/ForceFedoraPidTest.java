...
public class ForceFedoraPidTest {
    ...
    static String identifier = "84813133|870971";
    ...
    public void getCargoContainerTest() throws Exception 
    {
        ...
        String identifierLeftSide = identifier.substring( 0, identifier.indexOf( '|' ) );
        String constructedID = "dbc" + ":" + identifierLeftSide; 
