...
public class FedoraRelsExtTest
{
    ...
    static final String expected_relsext    = "<?xml version=\"1.0\" ?><rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:fedora=\"info:fedora/fedora-system:def/relations-external#\" xmlns:oai_dc=\"http://www.openarchives.org/OAI/2.0/oai_dc/\" xmlns:rdfs=\"http://www.w3.org/2000/01/rdf-schema#\"><rdf:Description rdf:about=\"info:fedora/"
                                                    ...
                                                    + coll_pid
                                                    + "</fedora:isMemberOfCollection></rdf:Description></rdf:RDF>";
    ...
    /**
     * Conformance test that verifies the minimal expectancies of a RELS-EXT
     * stream
     */
    @Test
    ...
    public void testAddRelation() throws XMLStreamException
    {
        ...
        instance.addRelationship( new QName( FedoraNamespace.FEDORARELSEXT.getURI(),
                "isMemberOfCollection", FedoraNamespace.FEDORA.getPrefix() ), new QName( "", "1",
