...
/**
 * \file PhraseConverterTest.java
 * \brief Tests the phrase conversion
 */
...
public class PhraseConverterTest {
    ...
    static String expectedOutput = "tååeststr";
    ...
    public void testPhraseConversion() {
     MockSimpleXmlValueConverterTrue mockSimpleXmlValueConverter = new MockSimpleXmlValueConverterTrue();
        ...
        PhraseConverter instance = new PhraseConverter();
