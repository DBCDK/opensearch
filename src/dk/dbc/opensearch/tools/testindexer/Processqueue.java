...
public class Processqueue implements IProcessqueue {
    ...
    public Vector< InputPair< String, Integer > > popAll() throws SQLException{return null;}
    public Vector< InputPair< String, Integer > > pop( int maxSize ) throws SQLException{return null;}
