...
public class PluginFinder {
    ...
    private void updatePluginClassNameMap( String path ) throws FileNotFoundException{//, TasksNotValidatedException{
        ...
        Vector<Pair<String, Throwable>> failedPlugins = new Vector<Pair<String, Throwable>>();
        ...
        while( pluginNameIter.hasNext() )
        {
            ...
            try{
                ...
                failedPlugins.add( new Pair( pluginName, saxe ) );
            }   
