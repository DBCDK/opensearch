...
public class PluginLoader
{
    ...
    HashMap<String, IPluggable> pluginMap;
    ...
    {
        this.cl = cl;
        pluginMap = new HashMap<String, IPluggable>();
    }
     ...
     * @throws InstantiationException if the classloader cant instantiate the desired plugin
    ...
    {
        IPluggable thePlugin;

        //find the plugin in the map and return it
        thePlugin = (IPluggable)pluginMap.get( pluginClassName );
        if( !( thePlugin == null ) )
        {
            return thePlugin;
        }
        else//load it, put it in the map and return it
        {
            try
            {
                ...
                thePlugin = ( IPluggable )loadedClass.newInstance();
                pluginMap.put( pluginClassName, thePlugin );
