...
{    
    ...
    private Collection< Pair<QName, QName> > triples;
    ...
    {        
        ...
        triples = new ArrayList< Pair< QName, QName >>();
    }
    ...
    public boolean addRelationship( QName predicate, QName object )
    {
        ...
        if( added )
        {
            triples.add( new Pair<QName, QName>(predicate, object) );
        }
        return added;
    }
    ...
    public void serialize( OutputStream out, String identifier ) throws XMLStreamException
    {
        ...
        try
        {
            ...
            for( Pair<QName, QName> set : triples )
            {
