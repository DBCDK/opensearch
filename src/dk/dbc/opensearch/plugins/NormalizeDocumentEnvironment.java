...
public class NormalizeDocumentEnvironment implements IPluginEnvironment
{

    private static Logger log = Logger.getLogger( NormalizeDocumentEnvironment.class );

    private IObjectRepository objectRepository;

    public NormalizeDocumentEnvironment( IObjectRepository repository, Map<String, String> args ) throws PluginException
    {
     ...
     */
    public CargoContainer run( CargoContainer cargoContainer ) throws PluginException
    {
